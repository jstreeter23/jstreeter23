...
My daily tools include **Cursor** (my main IDE), **Google Colab** for data analysis, **Penpot** for frontend design, and **Make** for simple automations. I keep my life organized in **Notion** and use **Mimo** for extra coding reps.
